...
class _CreateOrderState extends State<CreateOrder> {
  ...
  bool _isArticleGroupValid = true; // Tracks if article group is valid
  int? _editingIndex;
  int _offset = 0;
  ...
  void _addEntry() {
    if (_formKey.currentState!.validate() && _isArticleGroupValid) {
      setState(() {
        ...
        _isArticleGroupValid = true; // Reset validation
        _tableRows.clear();
        _addTableRow();
      });
  ...
  void _editEntry(int index) {
    setState(() {
      ...
      _isArticleGroupValid = true; // Valid during editing
      _tableRows.clear();
      _tableRows.add({
                            ...
                            onChanged: _disableDropdowns
                                ...
                                : (value) {
                                    setState(() {
                                      ...
                                      brandTypeData.clear();
                                      _tableRows.clear();
                                      _isArticleGroupValid = true; // Reset
                                      _addTableRow();
                                    });
